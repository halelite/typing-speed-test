...
import { calculateAccuracy, calculateWpm } from "@/assets/helpers";
...
const TextSection = ({
  ...
  const correctLetters = typedText
    .split("")
  ...
  useEffect(() => {
    ...
    setWpm(calculateWpm(totalLetters, totalElapsedTime));
    setAccuracy(calculateAccuracy(correctLetters, totalLetters));
  }, [typedText, totalLetters, totalElapsedTime]);
